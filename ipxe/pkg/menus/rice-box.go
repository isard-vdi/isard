...
func init() {
	...
	file2 := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1542190363, 0),
	...
	file7 := &embedded.EmbeddedFile{
		Filename:    "individualVM.ipxe",
		FileModTime: time.Unix(1542192019, 0),
		Content:     string("#!ipxe\nchain {{.BaseURL}}/pxe/boot/start?tkn={{.Token}}&id={{.VMID}}"),
	}
	...
	dir1 := &embedded.EmbeddedDir{
		Filename:   "",
		DirModTime: time.Unix(1542191948, 0),
