...
class TestHypervisorsHandler:
    ...
    @pytest.mark.asyncio
    @patch("handlers.hypervisors.Hypervisor.count_started_desktops", return_value=5)
    ...
    @pytest.mark.asyncio
    @patch("handlers.hypervisors.Hypervisor.count_started_desktops", return_value=3)
    ...
    @pytest.mark.asyncio
    @patch(
        "handlers.hypervisors.Hypervisor.get_hypervisor",
        return_value={"id": "h1", "status": "Offline"},
    )
    @patch("handlers.hypervisors.Hypervisor.count_started_desktops", return_value=0)
    ...
    @pytest.mark.asyncio
    @patch("handlers.hypervisors.Hypervisor.get_hypervisor")
    @patch("handlers.hypervisors.Hypervisor.count_started_desktops", return_value=7)
    ...
    @pytest.mark.asyncio
    @patch("handlers.hypervisors.Hypervisor.get_hypervisor")
    @patch("handlers.hypervisors.Hypervisor.count_started_desktops")
