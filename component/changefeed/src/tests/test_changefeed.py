...
import pytest
from table_changefeed import TableChangefeed, sanitize
...
class TestWaitForTables:
    ...
    def test_returns_immediately_when_all_tables_present(self):
        ...
        with patch("table_changefeed.r") as mock_r:
    ...
    def test_polls_until_all_tables_exist(self):
        ...
        with patch("table_changefeed.r") as mock_r, patch(
            "table_changefeed.asyncio.sleep", new=AsyncMock()
        ):
            table_list = MagicMock()
