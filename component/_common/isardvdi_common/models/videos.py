...
class Video(RethinkCustomBase):
    """
    Manage Video Objects

    Use constructor with keyword arguments to create new Video Objects or
    update an existing one using id keyword. Use constructor with id as
    first argument to create an object representing an existing Video Object.
    """
    ...
    def get_videos_names(cls):
        ...
        return {b["id"]: b["name"] for b in videos}
