...
class HypervisorsProcessed(RethinkSharedConnection):
    ...
    def get_vgpu_scheduled_profile_now(cls, card_id):
        ...
        from isardvdi_common.lib.bookings.gpu_realizability import canonical_profile_id
    ...
    def preview_force_profile(cls, card_id, target_profile):
        ...
        """
        from isardvdi_common.lib.bookings.gpu_realizability import canonical_suffix
