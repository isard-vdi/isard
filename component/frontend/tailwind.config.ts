...
export default {
  ...
  theme: {
    backgroundImage: {
      ...
      'maintenance-img': "url('@/assets/img/maintenance-img.svg')",
      'dots-img': "url('@/assets/img/bg-dots.svg')"
    },
    fontFamily: {
