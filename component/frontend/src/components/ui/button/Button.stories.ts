...
const meta = {
  ...
  argTypes: {
    ...
    iconSize: { control: 'select', options: ['sm', 'md', 'lg', 'xl'] }
  ...
  render: (args) => ({
    ...
    template: `<Button :hierarchy="args.hierarchy" :size="args.size" :icon="args.icon" :iconSize="args.iconSize">{{ args.label }}</Button>`
  })
...
export const PaginationButtonStory = createStory({ hierarchy: 'pagination-button' })
...
export const SecondaryGrayHover = createStory(
  { ...SecondaryGray.args },
  { pseudo: { hover: true } }
)
export const SecondaryColorHover = createStory(
  { ...SecondaryColor.args },
  { pseudo: { hover: true } }
)
export const TertiaryColorHover = createStory(
  { ...TertiaryColor.args },
  { pseudo: { hover: true } }
)
...
export const SecondaryColorFocus = createStory(
  { ...SecondaryColor.args },
  { pseudo: { focus: true } }
)
export const TertiaryColorFocus = createStory(
  { ...TertiaryColor.args },
  { pseudo: { focus: true } }
)
...
export const Pagination = createStory(
