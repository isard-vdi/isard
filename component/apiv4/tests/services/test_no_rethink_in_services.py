...
# Anchored on the installed package, not on this file's location, so the
# guard keeps pointing at the real service tree wherever the tests live.
_SERVICES_ROOT = Path(api.__file__).resolve().parent / "services"
