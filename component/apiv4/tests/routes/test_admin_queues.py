...
def _repo_root() -> Path:
    """Walk up to the uv workspace root instead of counting parents.

    These assertions read alloy/vmalert configs owned by the repo root; a
    fixed ``parents[N]`` silently turns into a skip the moment the file moves.
    """
