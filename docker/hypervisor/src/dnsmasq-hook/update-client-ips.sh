...
# Use the venv console script: alpine base may not ship /usr/bin/python3, and isardvdi_apiv4_client only lives in the venv.
/.venv/bin/isardvdi-hypervisor-update-client-ips "$@"
