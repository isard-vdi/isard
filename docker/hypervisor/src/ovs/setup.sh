...
ovs-ofctl -O OpenFlow13 add-meter ovsbr0 meter=2,pktps,burst,bands=type=drop,rate=1,burst_size=10
...
ovs-ofctl -O OpenFlow13 add-meter ovsbr0 meter=3,pktps,burst,bands=type=drop,rate=10,burst_size=50
...
ovs-ofctl -O OpenFlow13 add-meter ovsbr0 meter=4,pktps,burst,bands=type=drop,rate=10,burst_size=50
