...
Usage:
    /.venv/bin/isardvdi-hypervisor-gpu-apply --pci-bdf <BDF> \
        --target-profile <suffix> [--action apply|seed_and_apply] \
        [--mdevs-reset-at <iso-ts>] [--mig-profile-id <int>]
...
def _build_report(
    ...
    # GPU libs being importable.
    from isardvdi_hypervisor import gpu_apply, gpu_discovery
