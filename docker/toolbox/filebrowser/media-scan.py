...
if subpath[0] == 'media': process_items(BASE_PATH+'media',[".iso", ".fd"],'hypervisor/media_found')
...
if subpath[0] == 'groups': process_items(BASE_PATH+'groups',[".qcow", ".qcow2"],'hypervisor/disks_found')
if subpath[0] == 'all': 
