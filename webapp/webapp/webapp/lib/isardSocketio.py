                        ...
                        if c["new_val"] == None:
                            ...
                            if data["kind"] == "desktop":
                                ...
                                try:
                                    ...
                                    data[
                                        "derivates"
                                    ] = app.adminapi.get_admin_domains_with_derivates(
                                        id=c["new_val"]["id"], kind="template"
                                    ).get(
                                        "derivates"
                                    )
                                except:
...
def socketio_hyper_add(form_data):
    if current_user.role == "admin":
        ...
        if (
            create_dict["capabilities"]["disk_operations"]
            or create_dict["capabilities"]["hypervisor"]
        ):
                ...
                info = json.dumps(
                    {
                        ...
                        "text": "Hypervisor "
                        + create_dict["hostname"]
                        + " can't be created. Maybe it already exists!",
                        "icon": "warning",
                        "type": "error",
                    }
                )
            ...
            info = json.dumps(
                {
                    "result": False,
                    "title": "Hypervisor add error",
                    "text": "Hypervisor should have at least one capability!",
                    "icon": "warning",
                    "type": "error",
                }
            )
            socketio.emit(
                "result", info, namespace="/isard-admin/sio_admins", room="hyper"
            )
                ...
                info = json.dumps(
                    {
                        ...
                        "text": "Hypervisor "
                        + create_dict["hostname"]
                        + " can't be edited. Maybe it already exists!",
                        "icon": "warning",
                        "type": "error",
                    }
                )
...
def socketio_hyper_delete(data):
    if current_user.role == "admin":
        ...
        socketio.emit("result", info, namespace="/isard-admin/sio_admins", room="hyper")
...
def socketio_hyper_domains_stop(data):
    if current_user.role == "admin":
        # ~ remote_addr=request.headers['X-Forwarded-For'].split(',')[0] if 'X-Forwarded-For' in request.headers else request.remote_addr.split(',')[0]
        res = app.adminapi.domains_stop(
            hyp_id=data["pk"], without_viewer=data["without_viewer"]
        )
        if res == False:
            info = json.dumps(
                {
...
def socketio_hyperpool_edit(form_data):
    if current_user.role == "admin":
        ...
        res = app.adminapi.update_table_dict(
            "hypervisors_pools",
            "default",
            {"viewer": {"domain": data["viewer"]["domain"]}},
        )
        ...
        if res is True:
            info = json.dumps(
                {
                    "result": True,
                    "title": "Edit hypervisor pool",
                    "text": "Hypervisor pool " + "default" + " has been edited.",
                    "icon": "success",
                    "type": "success",
                }
            )
            ...
            info = json.dumps(
                {
                    "result": False,
                    "title": "Edit hypervisor pool",
                    "text": "Hypervisor pool" + "default" + " can't be edited now.",
                    "icon": "warning",
                    "type": "error",
                }
            )
        socketio.emit(
            "add_form_result", info, namespace="/isard-admin/sio_admins", room="hyper"
        )
    else:
        info = json.dumps(
            {
                "result": False,
                "title": "Hypervisor pool edit error",
                "text": "Hypervisor pool should have at least one capability!",
                "icon": "warning",
                "type": "error",
            }
        )
    ...
    if current_user.role == "admin" or current_user.role == "manager":
        ...
        if exceeded != False:
            data = json.dumps(
                {
                    "result": False,
                    "title": "New user add quota exceeded.",
                    "text": "User "
                    + form_data["name"]
                    + " can't be created. "
                    + str(exceeded),
            ...
            data = json.dumps(
                {
                    "result": True,
                    "title": "New user",
                    "text": "User " + form_data["name"] + " has been created...",
                    "icon": "success",
                    "type": "success",
                }
            )
            ...
            data = json.dumps(
                {
                    "result": True,
                    "title": "User edit",
                    "text": "User " + form_data["name"] + " has been updated...",
                    "icon": "success",
                    "type": "success",
                }
            )
            ...
            data = json.dumps(
                {
                    "result": False,
                    "title": "User edit",
                    "text": "User " + form_data["name"] + " can't be updated!",
                    "icon": "warning",
                    "type": "error",
                }
            )
            ...
            data = json.dumps(
                {
                    ...
                    "text": "Category " + id + " has been deleted...",
                    "icon": "success",
                    "type": "success",
                }
            )
            ...
            data = json.dumps(
                {
                    "result": False,
                    "title": "Delete category",
                    "text": "Category " + id + " can't be deleted.",
                    "icon": "warning",
                    "type": "error",
                }
            )
            ...
            data = json.dumps(
                {
                    "result": True,
                    "title": "Delete group",
                    "text": "Group " + id + " has been deleted...",
                    "icon": "success",
                    "type": "success",
                }
            )
            ...
            data = json.dumps(
                {
                    "result": False,
                    "title": "Delete group",
                    "text": "Group " + id + " can't be deleted.",
                    "icon": "warning",
                    "type": "error",
                }
            )
    ...
    if current_user.role == "admin" or current_user.role == "manager":
        ...
        if exceeded != False:
            data = json.dumps(
                {
                    "result": False,
                    "title": "New bulk user add quota exceeded.",
                    "text": str(len(users))
            ...
            data = json.dumps(
                {
                    "result": False,
                    "title": "New user",
                    "text": "Something went wrong when creating "
                    + str(len(final_users))
                    + " can't be created. Maybe they already exists!",
                    "icon": "warning",
                    "type": "error",
                }
            )
    ...
    if current_user.role == "admin" or current_user.role == "manager":
        ...
        if res is True:
            info = json.dumps(
                {
                    "result": True,
                    "title": "User enable/disable",
                    "text": "User " + data["name"] + " enable/disable success.",
                    "icon": "success",
                    "type": "success",
                }
            )
            ...
            info = json.dumps(
                {
                    "result": False,
                    "title": "User enable/disable",
                    "text": "User " + data["name"] + " could not toggle enable status!",
                    "icon": "warning",
                    "type": "error",
                }
            )
...
def socketio_domains_add(form_data):
    ...
    if exceeded != False:
        data = json.dumps(
            {
                "result": False,
                "title": "New desktop quota exceeded.",
                "text": "Desktop "
                + form_data["name"]
                + " can't be created. "
                + str(exceeded),
        ...
        data = json.dumps(
            {
                "result": True,
                "title": "New desktop",
                "text": "Desktop " + create_dict["name"] + " is being created...",
                "icon": "success",
                "type": "success",
            }
        )
...
def socketio_admin_domains_add(form_data):
    ...
    if exceeded != False:
        ...
        socketio.emit(
            "add_form_result", data, namespace="/isard-admin/sio_admins", room="domains"
        )
        return
    ...
    socketio.emit(
        "adds_form_result", data, namespace="/isard-admin/sio_admins", room="domains"
    )
    socketio.emit(
        "adds_form_result",
        data,
        ...
        data = json.dumps(
            {
                "result": False,
                "title": "New desktop quota exceeded.",
                "text": "Desktop can't be created. " + str(exceeded),
                "icon": "warning",
                "type": "error",
            }
        )
        ...
        data = json.dumps(
            {
                ...
                "text": "Desktop with name "
                + create_dict["name"]
                + " can't be created as this users have one with the same name:"
                + str(res),
                "icon": "warning",
                "type": "error",
            }
...
def socketio_advanced_domains_recreate(deployment_id):
    ...
    create_dict = app.adminapi.get_user_deployment_create_dict(
        current_user.id, deployment_id
    )

    create_dict = parseHardware(create_dict)
    create_dict = quotas.limit_user_hardware_allowed(create_dict, current_user.id)
    res = app.isardapi.new_domains_from_tmpl(
        current_user, create_dict, ignoreexisting=True
    )
    if res is True:
        data = json.dumps(
            {
        ...
        data = json.dumps(
            {
                ...
                + str(res)
                + " \nas they already have one with the same name.",
                "icon": "warning",
                "type": "warning",
            }
        )
        ...
        data = json.dumps(
            {
                "result": False,
                "title": "Delete deployment",
                "text": "Could not delete deployment as there are desktops not stopped. Please stop them all before deleting deployment.",
                "icon": "warning",
                "type": "warning",
            }
        )
        ...
        data = json.dumps(
            {
                ...
                "text": "Desktop " + create_dict["name"] + " has been updated...",
                "icon": "success",
                "type": "success",
            }
        )
        ...
        data = json.dumps(
            {
                ...
                "result": True,
                "title": "Updated desktop",
                "text": "Desktop " + create_dict["name"] + " can't be updated.",
                "icon": "warning",
                "type": "error",
            }
        )
...
def socketio_domain_template_add(form_data):
    ...
    if exceeded != False:
        data = json.dumps(
            {
                "result": False,
                "title": "New template quota exceeded.",
                "text": "Template "
                + form_data["name"]
                + " can't be created. "
                + str(exceeded),
    ...
    partial_tmpl_dict = quotas.limit_user_hardware_allowed(
        partial_tmpl_dict, current_user.id
    )
    partial_tmpl_dict["create_dict"]["hardware"] = {
        **partial_tmpl_dict["hardware"],
        **partial_tmpl_dict["create_dict"]["hardware"],
    }
        ...
        data = json.dumps(
            {
                ...
                "text": "Template "
                + partial_tmpl_dict["name"]
                + " can't be created as it already exists. "
                + str(res),
                "icon": "warning",
                "type": "error",
            }
...
def socketio_admin_domains_update(data):
    ...
    if current_user.role not in ["admin", "manager"]:
        ...
        socketio.emit(
            "result", data, namespace="/isard-admin/sio_admins", room="domains"
        )
        return
    socketio.emit(
        "result",
        ...
        data = json.dumps(
            {
                "id": data["id"],
                "result": True,
                "title": "Updated forced hypervisor",
                "text": "Forced hypervisor has been updated...",
                "icon": "success",
                "type": "success",
            }
        )
        ...
        data = json.dumps(
            {
                ...
                "result": False,
                "title": "Updated forced hypervisor",
                "text": "Forced hypervisor can't be updated.",
                "icon": "warning",
                "type": "error",
            }
        )
    socketio.emit("result", data, namespace="/isard-admin/sio_admins", room="domains")
        ...
        data = json.dumps(
            {
                ...
                "result": False,
                "title": "Updated desktop as server",
                "text": "Server desktop can't be updated.",
                "icon": "warning",
                "type": "error",
            }
        )
...
def socketio_admins_domain_edit(form_data):
    ...
    socketio.emit(
        "edit_form_result", data, namespace="/isard-admin/sio_admins", room="domains"
    )
        ...
        data = json.dumps(
            {
                "id": create_dict["ids"],
                "result": True,
                "title": "Updated desktops",
                "text": "Desktop " + str(create_dict["ids"]) + " has been updated...",
                "icon": "success",
                "type": "success",
            }
        )
        ...
        data = json.dumps(
            {
                ...
                "result": False,
                "title": "Updated desktops",
                "text": "Desktop " + str(create_dict["ids"]) + " can't be updated.",
                "icon": "warning",
                "type": "error",
            }
        )
    ...
    if "boot_order" not in create_dict["hardware"].keys():
        try:
            create_dict["hardware"]["boot_order"] = [
                app.isardapi.get_alloweds(current_user.id, "boots", pluck=["id"])[0][
                    "id"
                ]
            ]
        except:
    ...
    if "interfaces" not in create_dict["hardware"].keys():
        try:
            create_dict["hardware"]["interfaces"] = [
                app.isardapi.get_alloweds(current_user.id, "interfaces", pluck=["id"])[
                    0
                ]["id"]
            ]
        except:
    ...
    if "graphics" not in create_dict["hardware"].keys():
        try:
            create_dict["hardware"]["graphics"] = [
                app.isardapi.get_alloweds(current_user.id, "graphics", pluck=["id"])[0][
                    "id"
                ]
            ]
        except:
    ...
    if "videos" not in create_dict["hardware"].keys():
        try:
            create_dict["hardware"]["videos"] = [
                app.isardapi.get_alloweds(current_user.id, "videos", pluck=["id"])[0][
                    "id"
                ]
            ]
        except:
    ...
    if "hypervisors_pools" not in create_dict.keys():
        try:
            create_dict["hypervisors_pools"] = [
                app.isardapi.get_alloweds(
                    current_user.id, "hypervisors_pools", pluck=["id"]
                )[0]["id"]
            ]
        except:
...
def parseHardware(create_dict):
    ...
    if "template" in create_dict:
        data = app.isardapi.get_domain(
            create_dict["template"], human_size=False, flatten=False
        )
    else:
        data = app.isardapi.get_domain(
            create_dict["id"], human_size=False, flatten=False
        )
    ...
    create_dict["hardware"]["vcpus"] = (
        int(create_dict["hardware"]["vcpus"])
        if "vcpus" in create_dict["hardware"].keys()
        else int(original_create_dict["hardware"]["vcpus"])
    )
    create_dict["hardware"]["memory"] = (
        int(float(create_dict["hardware"]["memory"]) * 1048576)
        if "memory" in create_dict["hardware"].keys()
        else int(float(original_create_dict["hardware"]["memory"]))
    )
    create_dict["hardware"]["graphics"] = (
        [create_dict["hardware"]["graphics"]]
        if "graphics" in create_dict["hardware"].keys()
        else original_create_dict["hardware"]["graphics"]
    )
    create_dict["hardware"]["videos"] = (
        [create_dict["hardware"]["videos"]]
        if "videos" in create_dict["hardware"].keys()
        else original_create_dict["hardware"]["videos"]
    )
    create_dict["hardware"]["boot_order"] = (
        [create_dict["hardware"]["boot_order"]]
        if "boot_order" in create_dict["hardware"].keys()
        else original_create_dict["hardware"]["boot_order"]
    )
    create_dict["hardware"]["interfaces"] = (
        create_dict["hardware"]["interfaces"]
        if "interfaces" in create_dict["hardware"].keys()
        else original_create_dict["hardware"]["interfaces"]
    )
    create_dict["hardware"]["qos_id"] = (
        create_dict["hardware"]["qos_id"]
        if "qos_id" in create_dict["hardware"].keys()
        else original_create_dict["hardware"]["qos_id"]
        if "qos_id" in original_create_dict["hardware"].keys()
        else False
    )
    create_dict["hypervisors_pools"] = (
        [create_dict["hypervisors_pools"]]
        if "hypervisors_pools" in create_dict
        else original_create_dict["hypervisors_pools"]
    )
    ...
    """ if 'forced_hyp' in create_dict.keys():
        ...
        create_dict['forced_hyp']=False """
    create_dict["forced_hyp"] = (
        [create_dict["forced_hyp"]]
        if "forced_hyp" in create_dict.keys()
        else (
            original_create_dict["forced_hyp"]
            if "forced_hyp" in original_create_dict.keys()
            else False
        )
    )
        ...
        msg = json.dumps(
            {
                "result": True,
                "title": "VPN",
                "text": "VPN could not be opened. Try again.",
                "icon": "warning",
                "type": "error",
            }
        )
        ...
        info = json.dumps(
            {
                "result": True,
                "title": "New media",
                "text": "Media is being downloaded...",
                "icon": "success",
                "type": "success",
            }
        )
        ...
        info = json.dumps(
            {
                "result": False,
                "title": "New media",
                "text": "Media can't be created. " + str(res),
                "icon": "warning",
                "type": "error",
            }
        )
    socketio.emit(
        "add_form_result", info, namespace="/isard-admin/sio_admins", room="media"
    )
...
def socketio_media_add(form_data):
    ...
    if exceeded != False:
        data = json.dumps(
            {
                "result": False,
                "title": "New media quota exceeded.",
                "text": "Media "
                + form_data["name"]
                + " can't be created. "
                + str(exceeded),
...
def socketio_admin_domains_media_add(form_data):
    ...
    if create_dict["kind"] == "iso":
        ...
        res = app.adminapi.domain_from_media(
            current_user.id,
            name,
            description,
            icon,
            ...
            info = json.dumps(
                {
                    "result": True,
                    "title": "New desktop",
                    "text": "Desktop " + name + " is being created...",
                    "icon": "success",
                    "type": "success",
                }
            )
            ...
            info = json.dumps(
                {
                    "result": False,
                    "title": "New desktop",
                    "text": "Desktop " + name + " can't be created.",
                    "icon": "warning",
                    "type": "error",
                }
            )
    ...
    if create_dict["kind"].startswith("qcow"):
        ...
        create_dict.pop("allowed", None)
        res = app.adminapi.domain_from_disk(
            current_user.id, name, description, icon, create_dict, hyper_pools
        )
        if res is True:
            info = json.dumps(
                {
            ...
            data = json.dumps(
                {
                    "result": False,
                    "title": "Update " + table,
                    "text": "Something went wrong. Could not update!",
                    "icon": "warning",
                    "type": "error",
                }
            )
        socketio.emit(
            "result" if res == False else "add_form_result",
            data,
            namespace="/isard-admin/sio_admins",
            room="user_" + current_user.id,
        )
            ...
            data = json.dumps(
                {
                    ...
                    "text": "Permissions updated for " + data["id"],
                    "icon": "success",
                    "type": "success",
                }
            )
            ...
            data = json.dumps(
                {
                    "result": True,
                    "title": "Update permissions",
                    "text": "Something went wrong. Could not update permissions!",
                    "icon": "warning",
                    "type": "error",
                }
            )
...
def socketio_domains_virtualbuilder_add(form_data):
    ...
    res = app.adminapi.domain_from_virtbuilder(
        current_user.id, name, description, icon, create_dict, hyper_pools, disk_size
    )
    if res is True:
        info = json.dumps(
            {
