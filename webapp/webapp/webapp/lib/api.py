...
class isard():
    ...
    def get_user_domains(self, user, filterdict=False):
        ...
        with app.app_context():
            ...
            domains=[d for d in domains if 'tag_visible' not in d.keys() or ('tag_visible' in d.keys() and d['tag_visible']==True)]
        return domains
    ...
    def new_domain_from_tmpl(self, user, create_dict):
        ...
        new_domain={'id': '_'+user+'-'+parsed_name,
                  ...
                  'tag_visible':create_dict['tag_visible'] if 'tag' in create_dict.keys() else True,
                  'kind': 'desktop',
                  'user': userObj['id'],
                  'username': userObj['username'],
                  'status': 'Creating',
