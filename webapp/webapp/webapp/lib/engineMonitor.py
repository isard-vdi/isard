            ...
            try:
                ...
                if s.status_code != 200:
                    data = {
                        "code": 1,
                        "status": "unknown",
                        "desc": "ERROR: Engine api status code " + str(s.status_code),
                        "data": False,
                    }
                    if last == True:
                        last = False
                ...
                dict = s.json()
                status = {
                    "background": dict["background_is_alive"],
                ...
                if all(value for value in status.values()) == True:
                    ...
                    data = {
                        "code": 2,
                        "status": "fail",
                        "desc": "ERROR: Engine threads with errors.",
                        "data": status,
                    }
                    if last == True:
                        last = False
                ...
                data = {
                    "code": 1,
                    "status": "unknown",
                    "desc": "ERROR: Engine api not answering.",
                    "data": False,
                }
                if last == True:
                    last = False
