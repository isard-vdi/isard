...
$(document).ready(function () {
    ...
    $("#BastionConfig #btn-delete-disallowed").on("click", function () {
        new PNotify({
            ...
            text: `The bastion targets are deleted automaticaly when editing the bastion alloweds and this should be used if you believe something went wrong when you updated the allowed users. This will check all targets and delete the ones that are disallowed.
