...
logs_users_category_table = null;
...
$(document).ready(function () {
    var debounceZoom = debounce(function (params) {
        ...
        if ($("#btn-category-view-tab").hasClass("active")){
            logs_users_category_table.clearPipeline().draw();
        }
    }, 2000);
    ...
    $(".nav-link").click(function(e){
        ...
        if ($(this).attr('id') == 'btn-category-view-tab'){
            if (logs_users_category_table == null){
                category_table();
            }else{
                logs_users_category_table.clearPipeline().draw();
            }
...
function category_table(){
    ...
    $('#table-logs-category-user-view').on( 'length.dt', function ( e, settings, len ) {
        logs_users_category_table.clearPipeline().draw();
    } );
}
