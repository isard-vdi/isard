    ...
    data() {
        return {
            ...
            menu : [
                ...
                {label: 'Desktops', icon: 'pi pi-fw pi-desktop', to: '/desktops'},
                {label: 'Templates', icon: 'pi pi-fw pi-clone', to: '/'},
                {label: 'Media', icon: 'pi pi-fw pi-circle-off', to: '/'},
                {
					label: 'Administración', icon: 'pi pi-fw pi-sitemap',
					items: [
                        {label: 'Login', icon: 'pi pi-fw pi-id-card', to: '/'},
                        {label: 'Users', icon: 'pi pi-fw pi-users', to: '/users'},
                        {label: 'Entities', icon: 'pi pi-fw pi-users', to: '/users'},
                        {label: 'Groups', icon: 'pi pi-fw pi-users', to: '/users'},
                        {label: 'Profiles', icon: 'pi pi-fw pi-users', to: '/users'},
					]
				},
				{
					...
					items: [
                        ...
                        {label: 'Isard Login', icon: 'pi pi-fw pi-id-card', to: '/isardlogin'},
