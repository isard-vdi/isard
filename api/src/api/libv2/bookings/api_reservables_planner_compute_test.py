...
_SRC = os.path.join(os.path.dirname(__file__), "api_reservables_planner_compute.py")
_WANTED = {
...
def test_zero_unit_windows_are_dropped():
    out = _H["join_consecutive_plans"]([_seg(10, 16, 0, "a")])
    assert out == []
