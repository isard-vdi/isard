...
``gpu_realizability`` is a dependency-free leaf module, so we import it directly
(prepending its own directory to ``sys.path``) without booting the Flask app in
``api/__init__``.
"""
...
import gpu_realizability as gr  # noqa: E402
