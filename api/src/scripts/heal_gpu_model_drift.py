...
Run inside the api container::
    ...
    docker exec -i isard-api python3 < api/src/scripts/heal_gpu_model_drift.py
    # or with --apply:
    docker exec isard-api python3 /api/scripts/heal_gpu_model_drift.py --apply
"""
...
def main():
    ...
    try:
        ...
        return 0 if not skipped else 0  # informational; non-fatal
    finally:
        conn.close()
